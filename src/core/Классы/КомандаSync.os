...
Процедура ЗарегистрироватьКоманду(Знач ИмяКоманды, Знач Парсер) Экспорт
	...
	Парсер.ДобавитьИменованныйПараметрКоманды(ОписаниеКоманды, "-pluginsdir", "<Путь к каталогу плагинов>");
	...
	Парсер.ДобавитьИменованныйПараметр("-pluginsdir", "<Путь к каталогу плагинов>");
...
Функция ВыполнитьКоманду(Знач ПараметрыКоманды, Знач ДополнительныеПараметры) Экспорт
	...
	КаталогПлагинов 						= ПараметрыКоманды["-pluginsdir"];
	...
	Лог.Отладка("КаталогПлагинов = " + КаталогПлагинов);
